...
class TestLogin:
    ...
    def test_check_title_textfield_is_accepting_the_text(self):
        ...
        time.sleep(3)
        self.driver.find_element(By.XPATH, landing.title_name).send_keys("dn57")
        time.sleep(3)
    ...
    def test_click_on_save_button_is_working(self):
        ...
        self.driver.find_element(By.XPATH, landing.folder_popup_title)
        time.sleep(2)
        self.driver.find_element(By.XPATH, landing.title_name).send_keys("dn73")
        time.sleep(3)
        self.driver.find_element(By.TAG_NAME, landing.description_text).send_keys(
            "To be concrete, descriptive writing has to offer specifics the reader can envision. Rather than “Her eyes were the color of blue rocks” (Light blue? Dark blue? Marble? Slate?), try instead, “Her eyes sparkled like sapphires in the dark.")
        time.sleep(3)
    ...
    def test_click_on_vision_tab_is_open(self):
        ...
        if verify_tc.is_displayed() == True:
            ...
            assert False
    #*******************************************************************************************************************
        # Check whether accepting without text vision is saveing or not
    def test_check_accepting_without_text_vision_is_save(self):
            shadow = self.driver.find_element(By.CSS_SELECTOR, landing.save_button)
            shadow.click()
            time.sleep(5)
            # test case verification
    ...
    def test_check_vision_title_textfield_is_accepting_the_text(self):
        ...
        self.driver.find_element(By.XPATH, "(//ion-input[@formcontrolname='title']/input)[2]").click()
        time.sleep(2)
        # test case verification
        verify_tc = self.driver.find_element(By.XPATH, landing.vision_popup_title)
    ...
    def test_click_on_save_button_is_working_vision_folder(self):
        ...
        self.driver.find_element(By.XPATH, landing.folder_popup_title)
        time.sleep(2)
        self.driver.find_element(By.XPATH, landing.title_name).send_keys("space41")
        time.sleep(3)
        self.driver.find_element(By.TAG_NAME, landing.description_text).send_keys(
            "To be concrete, descriptive writing has to offer specifics the reader can envision. Rather than “Her eyes were the color of blue rocks” (Light blue? Dark blue? Marble? Slate?), try instead, “Her eyes sparkled like sapphires in the dark.")
        time.sleep(3)
...
#     # ****************************************************************************************************************
#     # Click on Add a Existing Part  Check whether Add Assosiated Part tab is opening
#     def test_Add_Assosiated_Part_Tab_Must_be_open(self):
#         self.driver.find_element(By.XPATH, landing.plus_icon).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.add_new_menu).click()
#         time.sleep(2)
...
#     def test_click_whether_linked_items_displaying_or_not(self):
...
#             assert False
#     # *******************************************************************************************************************
#     # Click on Linked Items Check whether folders check box is select or not
#     def test_click_whether_folders_check_box_is_select_or_not(self):
#         self.driver.find_element(By.XPATH, landing.liked_iteams_check_box).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.liked_iteams_check_box)
#         print("Folder must be selected", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Check whether Add Linked items cancel button is working or not
#     def test_click_whether_folders_cancel_button_is_working_or_not(self):
#         self.driver.find_element(By.XPATH,landing.liked_iteams_cancel_button).click()
#         time.sleep(2)
#
#         verify_tc = self.driver.find_element(By.XPATH, landing.plus_icon)
#         print("Must be cancel", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Check whether Add Linked items save button is working or not
#     def test_click_whether_folders_save_button_is_working_or_not(self):
#         self.driver.find_element(By.XPATH, landing.dots_menu).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.click_linked_items_tab).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.liked_iteams_check_box).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.liked_iteams_save_button).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.plus_icon)
#         print("Must be save", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Click on Change folder Check whether change folders deatils are displaying or not
#     def test_click_whether_change_folder_displaying_or_not(self):
#         self.driver.find_element(By.XPATH, landing.click_change_folder_tab).click()
#         time.sleep(2)
#
#         verify_tc = self.driver.find_element(By.XPATH, landing.change_folder_title)
#         print(" Should be click the change folder ", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     #*********************************************************************************************************************
#     # Click on Change folder Check whether change folders cancel button working or not
#     def test_click_whether_change_folder_cancel_button_working_or_not(self):
#         self.driver.find_element(By.XPATH, landing.change_folder_cancel_button).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.plus_icon)
#         print(" Must be Cancel", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
...
#             assert False
#     # *******************************************************************************************************************
#     # Click on Change folder Check whether change folders save button working or not
#     def test_click_whether_change_folder_save_button_working_or_not(self):
#         self.driver.find_element(By.XPATH, landing.dots_menu).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.click_change_folder_tab).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.click_folder_options).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.change_folder_title)
#         print("Must be save", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
...
#             assert False
#     # *******************************************************************************************************************
#     # Click on comments Check whether comments is working or not
#     def test_click_whether_change_folder_comments_button_working_or_not(self):
#         self.driver.find_element(By.XPATH,landing.click_comments).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.dots_menu)
#         print("Must be add a comments display", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#               assert True
#         else:
#             assert False
#         # *******************************************************************************************************************
#     # Click on comments Check whether add comments is display or not
#     def test_click_add_comments_button_working_or_not(self):
#         self.driver.find_element(By.XPATH, landing.click_add_a_comments).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.add_a_comments_title)
#         print("Must be add a comments display", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Click on comments Checkwhether add comments click save without data entering
#     def test_click_add_comments_click_save_without_data_entering(self):
#         self.driver.find_element(By.XPATH, landing.add_a_comments_save_button).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.add_a_comments_error_msg).click()
#         time.sleep(2)
#         self.driver.find_element(By.CSS_SELECTOR, landing.add_a_comments_close_window).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.dots_menu)
#         print("Must be invalid credicals", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Click on comments Checkwhether add comments click save without data entering
#     def test_click_add_comments_click_cancel_button_is_working_or_not(self):
#         self.driver.find_element(By.XPATH, landing.click_add_a_comments).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.add_a_comments_cancel_button).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.plus_icon)
#         print(" Must be Cancel ", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
...
#             assert False
#     #*******************************************************************************************************************
#     # Click on comments Check whether add comments is  accepting the text or not
#     def test_click_add_comments_is_accepting_text_or_not(self):
#         self.driver.find_element(By.XPATH, landing.click_add_a_comments).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.add_a_comments_text_field).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.add_a_comments_text_field).send_keys("it's testing")
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.add_a_comments_text_field)
#         print(" Must be accept the text ", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Check whether comment assign to drop  down is working or not
#     def test_click_add_comments_assign_to_dropdown_working_or_not(self):
#         self.driver.find_element(By.XPATH,landing.add_a_comments_drop_down).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.add_a_comments_text_field)
#         print("assign to drop down is must be display", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Check whether comment assign to drop down names is displayed  or not
#     def test_click_add_comments_assign_to_dropdown_names_is_displayed_or_not(self):
#         self.driver.find_element(By.XPATH,landing.commants_name_checkbox)
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.commants_name_checkbox).click()
#         time.sleep(2)
#         verify_tc = self.driver.find_element(By.XPATH, landing.add_a_comments_text_field)
#         print("assign to drop down names is must be display", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     # Check whether comment save button working or not
#     def test_click_add_comments_save_button_working_or_not(self):
#         self.driver.find_element(By.XPATH,landing.add_a_comments_title).click()
#         time.sleep(2)
#         self.driver.find_element(By.XPATH, landing.add_a_comments_save_button).click()
#         time.sleep(5)
#         verify_tc = self.driver.find_element(By.XPATH, landing.click_add_a_comments)
#         print("must be save comment", verify_tc.is_displayed())
#         if verify_tc.is_displayed() == True:
#             assert True
#         else:
#             assert False
#     # *******************************************************************************************************************
#     #Check whether comment edit button working or not
#     def test_click_add_comments_edit_commants_button_working_or_not(self):
#         self.driver.find_element(By.XPATH,"//ion-col[contains(@class,'ion-float-right ng-star-inserted md hydrated')]").click()
#         time.sleep(2)